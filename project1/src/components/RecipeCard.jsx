...
const RecipeCard = ({ recipe }) => {
  ...
  const { id, title, chef, description, image } = recipe;

  return (
    <Link
      to={`/recipe/${id}`}
      className="duration-150 hover:scale-105 mr-3 mb-3 block border p-4 rounded shadow hover:shadow-lg transition"
    >
      <img
